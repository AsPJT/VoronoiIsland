...
constexpr void output(const STL_& stl_) noexcept {
	for (size_t y{}; y < stl_.size(); ++y) {
		for (size_t x{}; x < stl_[y].size(); ++x) {
			if (stl_[y][x]) DrawPixel((int)x, (int)y, GetColor(63, 155, 76));//63, 155, 76//119,103,52
